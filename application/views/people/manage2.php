                ...
                <table id="datatable" class="table table-hover table-bordered" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center"><?= $this->lang->line('common_desarrollo') ?></th>
                            <th style="text-align: center"><?= $this->lang->line('common_sm') ?></th>
                            <th style="text-align: center"><?= $this->lang->line('common_lote') ?></th>
                            <th style="text-align: center"><?= $this->lang->line('common_estado') ?></th>
...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        $("#datatable").dataTable({
            ...
            "order": [1, "desc"],
            "ajax": {
                "url": "<?php echo site_url("lotes/data") ?>",
